...
silent only
silent tabonly
cd ~/Desktop/codes/webapps/drisac/frontend
...
badd +168 templates/dashboard.html
badd +58 views.py
badd +0 urls.py
argglobal
%argdel
...
wincmd w
argglobal
if bufexists(fnamemodify("templates/dashboard.html", ":p")) | buffer templates/dashboard.html | else | edit templates/dashboard.html | endif
if &buftype ==# 'terminal'
  silent file templates/dashboard.html
endif
balt templates/dashboard.html
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 169 - ((11 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 169
